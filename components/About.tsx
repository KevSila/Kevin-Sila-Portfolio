...
const About: React.FC = () => {
  const designTools = ['Figma', 'Canva', 'Adobe XD', 'Google Sites', 'WordPress'];
  const devSkills = ['Python', 'HTML', 'CSS', 'JavaScript', 'SQL', 'PHP', 'MySQL', 'Laravel'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {designTools.map((tool) => (
                    <span key={tool} className="px-3 py-1 bg-slate-800 border border-slate-700 rounded-full text-xs text-slate-300 hover:border-accent hover:text-white transition-colors">
                      {tool}
                    </span>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {devSkills.map((skill) => (
                    <span key={skill} className="px-3 py-1 bg-slate-800 border border-slate-700 rounded-full text-xs text-slate-300 hover:border-accent hover:text-white transition-colors">
                      {skill}
                    </span>
                  ))}
                </div>
          ...
          <div className="w-full">
            <div className="w-full h-[400px] bg-primary rounded-2xl border border-slate-700 p-4 relative shadow-xl">
